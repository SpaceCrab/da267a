...
// test succeeds if the added data is the same and in the same order as the
// added data
...
// adds two values to the buffer and the checks if the buffer contains the
// second value test succeeds if the contains function returns the second value
...
// fills the buffer with data and then checks if the buffer contains the last
// value added the test succeeds if the contains function returns the last value
// added
...
// initializes a new buffer and then checks if the buffer contains the proper
// values for maxLength, head, and tail test succeeds if the buffer contains the
// proper values
void testInit()
{
    struct circularBuffer buffer;
